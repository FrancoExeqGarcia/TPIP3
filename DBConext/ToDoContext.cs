...
namespace TODOLIST.DBContext
{
    public class ToDoContext : DbContext
    {
        ...
        public DbSet<SuperAdmin> Superadministrators { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                ...
                new SuperAdmin { Id = 3, Name = "Superadmin1", Password = "superadminpassword1", Email = "superadmin1@example.com", Role = "superadmin" }
            );
            ...
            modelBuilder.Entity<SuperAdmin>().HasData(
                new SuperAdmin { Id = 5, Name = "Superadmin2", Password = "superadminpassword2", Email = "superadmin2@example.com", Role = "superadmin" }
            );
